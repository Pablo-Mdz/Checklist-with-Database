...
#curring (retrass ejecution of a function)
def complete(id):
    def _complete():
...
def render_todos():
    ...
    for i in range(0,len(rows)):
        ...
        btn = Button(frame,text='Remove', command=remove(id))
...
frame = LabelFrame(root,text='My Homework', padx=5, pady=5)
